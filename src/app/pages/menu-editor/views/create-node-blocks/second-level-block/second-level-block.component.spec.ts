...
import { SecondLevelBlockComponent } from './second-level-block.component';

describe('SecondLevelBlockComponent', () => {
  let component: SecondLevelBlockComponent;
  let fixture: ComponentFixture<SecondLevelBlockComponent>;
  let expectedTree: Tree<any>;
  let expectedNode: TreeNode<SecondLevelBlock>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ SecondLevelBlockComponent ],
    })
    .compileComponents();
  }));
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(SecondLevelBlockComponent);
